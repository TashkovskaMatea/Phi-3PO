...
model_gptq.push_to_hub(
 repo_id="StefanKrsteski/Phi-3-mini-4k-instruct-sft-3bit",
)

tokenizer.push_to_hub("StefanKrsteski/Phi-3-mini-4k-instruct-sft-3bit")
